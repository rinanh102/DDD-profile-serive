...
export type CreateProfileLaityUseCaseAttributesInput = ProfileLaityAttributesDto;
export class CreateProfileLaityUseCaseAttributesInputModel extends CreateProfileCommonUseCaseAttributesInputModel
    implements CreateProfileLaityUseCaseAttributesInput
{
    @Expose()
    @IsOptional()
    @IsString()
...
export type CreateProfileLaityUseCaseSubInput = {
    attributes: CreateProfileLaityUseCaseAttributesInput;
};
export class CreateProfileLaityUseCaseSubInputModel implements CreateProfileLaityUseCaseSubInput {
    @Expose()
    @IsNotEmpty()
    @ValidateNested()
    @Type(() => CreateProfileLaityUseCaseAttributesInputModel)
    public readonly attributes!: CreateProfileLaityUseCaseAttributesInput;
}


export type CreateProfileLaityUseCaseBeforeValidateInput = Omit<
    CreateProfileUseCaseInput,
    'attributeValues'
> & {
    attributes: CreateProfileLaityUseCaseAttributesInput;
};
export type CreateProfileLaityUseCaseBeforeValidateOutput = CreateProfileUseCaseValidateInput;
